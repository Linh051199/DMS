...
export const InsuranceFeePage = () => {
  ...
  const columns: ColumnOptions[] = useMemo(
    () => [
      ...
      {
        caption: "Tỉ lệ bảo hiểm (VAT)",
        dataField: "InsurancePercent",
        editorType: "dxTextBox",
  ...
  const handleDelete = async (key: string) => {
    const resp = await api.Mst_InsuranceFee_Delete(key);
    if (resp.isSuccess) {
  ...
  const handleCreate = async (data: any) => {
    const res = await api.Mst_InsuranceFee_Create({ ...data });
    if (res.isSuccess) {
  ...
  return (
    <AdminContentLayout className={"insurance-fee"}>
      ...
      <AdminContentLayout.Slot name="Content">
        <BaseGridView
          ...
          storeKey={"Mst_InsuranceFee_Columns"}
