...
export const CabinCertificatePage = () => {
  ...
  const handleDelete = async (key: string) => {
    const resp = await api.Mst_CabinCertificate_Delete(key);
    if (resp.isSuccess) {
  ...
  const handleCreate = async (data: any) => {
    const res = await api.Mst_CabinCertificate_Create({ ...data });
    if (res.isSuccess) {
  ...
  const handleDeleteRows = async (rows: string[]) => {
    const resp = await api.Mst_CabinCertificate_DeleteMultiple(rows);
    if (resp.isSuccess) {
  ...
  return (
    <AdminContentLayout className={"cabin-certificate"}>
      <AdminContentLayout.Slot name="Header">
        <PageHeaderLayout>
          <PageHeaderLayout.Slot name="Before">
            <div className="font-bold dx-font-m">
              Quản lý giấy chứng nhận thùng
            </div>
      ...
      <AdminContentLayout.Slot name="Content">
        <BaseGridView
          ...
          storeKey={"Mst_CabinCertificate_Columns"}
