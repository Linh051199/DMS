...
export const UnitPriceGPSPage = () => {
    ...
    () => [
      {
        ...
        headerFilter: {
          alowwSearch: true,
          dataSource: uniqueFilterByDataField(data?.DataList, "ContractNo"),
        },
...

      {
        ...
        headerFilter: {
          alowwSearch: true,
          dataSource: uniqueFilterByDataField(data?.DataList, "EffStartDate"),
        },
        validationRule: [requiredType, ExcludeSpecialCharactersType],
      },
  ...
  const handleDelete = async (key: string) => {
    const resp = await api.Mst_UnitPriceGPS_Delete(key);
    if (resp.isSuccess) {
  ...
  const handleCreate = async (data: any) => {
    const res = await api.Mst_UnitPriceGPS_Create({ ...data });
    if (res.isSuccess) {
  ...
  return (
    <AdminContentLayout className={"unit-price-GPS"}>
      <AdminContentLayout.Slot name="Header">
        <PageHeaderLayout>
          <PageHeaderLayout.Slot name="Before">
            <div className="font-bold dx-font-m">Quản lý đơn giá GPS</div>
      ...
      <AdminContentLayout.Slot name="Content">
        <BaseGridView
          keyExpr="ContractNo"
          storeKey={"Mst_UnitPriceGPS_Columns"}
