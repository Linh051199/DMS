...
export const InsuranceCompanyPage = () => {
    ...
    () => [
      {
        ...
        headerFilter: {
          alowwSearch: true,
          dataSource: uniqueFilterByDataField(data?.DataList, "InsCompanyCode"),
        },
...

      {
        ...
        headerFilter: {
          alowwSearch: true,
          dataSource: uniqueFilterByDataField(data?.DataList, "InsCompanyName"),
        },
        validationRule: [requiredType, ExcludeSpecialCharactersType],
      },
  ...
  const handleDelete = async (key: string) => {
    const resp = await api.Mst_InsuranceCompany_Delete(key);
    if (resp.isSuccess) {
  ...
  const handleCreate = async (data: any) => {
    const res = await api.Mst_InsuranceCompany_Create({ ...data });
    if (res.isSuccess) {
  ...
  const handleUpdate = async (key: string, data: any) => {
    const resp = await api.Mst_InsuranceCompany_Update(key, data);
    if (resp.isSuccess) {
    ...
    <AdminContentLayout>
      <AdminContentLayout.Slot name="Header">
        <PageHeaderLayout>
          <PageHeaderLayout.Slot name="Before">
            <div className="font-bold dx-font-m">Quản lý công ty bảo hiểm</div>
      ...
      <AdminContentLayout.Slot name="Content">
        <BaseGridView
          ...
          storeKey={"Mst_InsuranceCompany_Columns"}
