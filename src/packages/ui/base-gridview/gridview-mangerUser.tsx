...
const GridViewRaw = ({
  ...
  const setPopPup = useSetAtom(showPoppup);
  const setDataPopup = useSetAtom(checkDataPopPup);
  const setViewingItem = useSetAtom(viewingDataAtom);
  const cloneIconClick = useCallback((e: any) => {
    setViewingItem({
  ...
  const hanldeAssignFunction = useCallback((e: any) => {
    setViewingItem({
      rowIndex: e.row.rowIndex,
      item: e.row.data,
    });
        ...
        >
          ...
          >
            ...
            <DxButton
              ...
              name="assignUsers"
              icon={"http://cdn.onlinewebfonts.com/svg/img_316863.png"}
            ...
            <DxButton
              ...
              name="assignFunction"
              icon={"http://cdn.onlinewebfonts.com/svg/img_87881.png"}
              visible={isCloneIconVisible}
