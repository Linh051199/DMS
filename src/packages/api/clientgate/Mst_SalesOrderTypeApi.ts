...
export const useMst_SalesOrderTypeApi = (apiBase: AxiosInstance) => {
  return {
    ...
    Mst_SalesOrderType_GetAllActive: async () => {
      return await apiBase.post<Partial<Mst_SalesOrderType>, ApiResponse<Mst_SalesOrderType>>(
        "/MstSalesOrderType/GetAllActive"
      );
    },
